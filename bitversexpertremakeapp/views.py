...
def home(request):
	return render(request, 'bitversexpertremakeapp/index.html')


def plan(request):
	return render(request, 'bitversexpertremakeapp/plan.html')

def otherpayment(request):
    return render(request, 'bitversexpertremakeapp/otherpayment.html')


def about(request):
	return render(request, 'bitversexpertremakeapp/company.html')


def career(request):
	return render(request, 'bitversexpertremakeapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('bitversexpertremakeapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'bitversexpertremakeapp/login.html')


def privacy(request):
	return render(request, 'bitversexpertremakeapp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'bitversexpertremakeapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('bitversexpertremakeapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('bitversexpertremakeapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
		...
		second_template= render_to_string('bitversexpertremakeapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@bitversexpert.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'bitversexpertremakeapp/register.html', context)
...
def dashboard(request):
	...
	return render(request, 'bitversexpertremakeapp/dashboardtwo.html', context)
...
def admindashboard(request):
	...
	return render(request, 'bitversexpertremakeapp/adminpage.html', context)


def terms(request):
	return render(request, 'bitversexpertremakeapp/terms.html')


def realestate(request):
	return render(request, 'bitversexpertremakeapp/realestate.html')


def crypto(request):
	return render(request, 'bitversexpertremakeapp/crypto.html')


def forex(request):
	return render(request, 'bitversexpertremakeapp/forex.html')


def nft(request):
	return render(request, 'bitversexpertremakeapp/nft.html')


def contact(request):
	return render(request, 'bitversexpertremakeapp/contact.html')


def stocks(request):
	return render(request, 'bitversexpertremakeapp/stocks.html')


def agriculture(request):
	return render(request, 'bitversexpertremakeapp/agriculture.html')


def gold(request):
	return render(request, 'bitversexpertremakeapp/gold.html')


def retirement(request):
	return render(request, 'bitversexpertremakeapp/retirement.html')
	...
	if request.method=='POST':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.bitversexpert.com/dashboard",
			...
			template= render_to_string('bitversexpertremakeapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@bitversexpert.com'])
			except BadHeaderError:
				pass
			return redirect(generated_link)
	context={}
	return render(request, 'bitversexpertremakeapp/deposittwo.html', context)
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@bitversexpert.com'])
	...
	context={}
	return render(request, 'bitversexpertremakeapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'bitversexpertremakeapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'bitversexpertremakeapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'bitversexpertremakeapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'bitversexpertremakeapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'bitversexpertremakeapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'bitversexpertremakeapp/referralprofilestwo.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'bitversexpertremakeapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('bitversexpertremakeapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('bitversexpertremakeapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'bitversexpertremakeapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('bitversexpertremakeapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'bitversexpertremakeapp/account_settings.html', context)
...
def create_bonus(request):
	...
	if form.is_valid():
		...
		template= render_to_string('bitversexpertremakeapp/bonusNotification.html', {'message':message, 'amount':amount, 'code':code})
		plain_message= strip_tags(template)
		emailmessage= EmailMultiAlternatives(
		...
		emailmessage.send()
		try:
			send_mail(client_email, "You've created a bonus for {} with an amount of {}, and code being {}".format(client_email, amount, code),settings.EMAIL_HOST_USER, ['info@bitversexpert.com'])
		except BadHeaderError:
			pass
		return HttpResponse('You have successfully created a Bonus for your client')
	context={'form': form}
	return render(request, 'bitversexpertremakeapp/create_bonus.html', context)
	...
	if request.method == 'POST':
		...
		if payment_code:
			...
			if check_payment_code:
				...
				template= render_to_string('bitversexpertremakeapp/bonusComplete.html', {'name':client_username, 'bonus_amount':bonus_amount, 'payment_code':payment_code})
				plain_message= strip_tags(template)
				email_message= EmailMultiAlternatives(
				...
				email_message.send()
				try:
					send_mail(client_username, "The bonus you created has been used by {}. They recieved an amount of {}. ".format(client_username, bonus_amount),settings.EMAIL_HOST_USER, ['info@bitversexpert.com'])
				except BadHeaderError:
					pass
		...
		print(payment_code)
	context={}
	return render(request, 'bitversexpertremakeapp/use_bonus.html', context)
...
def meetrobert(request):
	...
	context={}
	return render(request, 'bitversexpertremakeapp/meetrobert.html', context)
...
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('bitversexpertremakeapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
